...
type MockService struct {
	...
	funcUnblock func(id uuid.UUID) error
}

// List
func (m *MockService) List(filter UserFilter) ([]User, error) {
	if m.funcList != nil {
		return m.funcList(filter)
	}
	return []User{}, nil
}
...
// Update
func (m *MockService) Update(id uuid.UUID, fields FieldsToUpdate) error {
	return m.funcUpdate(id, fields)
}

// Block
func (m *MockService) Block(id uuid.UUID) error {
	return m.funcBlock(id)
}

// Unblock
func (m *MockService) Unblock(id uuid.UUID) error {
	return m.funcUnblock(id)
}
